...
import android.os.Bundle;
        ...
        public class MainActivity extends AppCompatActivity {
            ...
            protected void onCreate(Bundle savedInstanceState) {
                ...
                entries.add(new Entry(215, 0));
                entries.add(new Entry(215, 1));
                entries.add(new Entry(215, 3));
                entries.add(new Entry(215, 4));
                entries.add(new Entry(215,5 ));
                entries.add(new Entry(215,6 ));
                entries.add(new Entry(215, 7));
                entries.add(new Entry(215,8 ));
                entries.add(new Entry(215, 9));
                entries.add(new Entry(215, 10));
                entries.add(new Entry(215, 11));
                entries.add(new Entry(215,12 ));
                entries.add(new Entry(215, 13));
                entries.add(new Entry(215, 14));
                entries.add(new Entry(215, 15));
                entries.add(new Entry(215, 16));
                entries.add(new Entry(215, 17));
                entries.add(new Entry(215,18 ));
                entries.add(new Entry(215,19 ));
                entries.add(new Entry(215,20 ));
                entries.add(new Entry(215, 21));
                entries.add(new Entry(215, 22));
                entries.add(new Entry(215,23 ));
                entries.add(new Entry(215, 24));
                entries.add(new Entry(215, 25));
                entries.add(new Entry(215, 26));

                entries.add(new Entry(0, 27));
                entries.add(new Entry(0, 28));
